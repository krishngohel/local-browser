...
Always: snapshot before click/type/fill. Use refs like e0, e1. snapshot/screenshot return a photo of the page. watch returns a short live feed for animations. Stop on captcha/login/2FA and ask the user to finish it in the Echo window, then wait_for.
`;
